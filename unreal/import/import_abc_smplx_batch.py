...
UNREAL_PROJECT_PATH = r"C:\Users\Ana\Documents\Unreal Projects\Bedlam\Bedlam.uproject"
IMPORT_SCRIPT_PATH = "C:/bedlam_render/unreal/import/import_abc_smplx.py" # need forward slashes when calling via -ExecutePythonScript
...
def worker(unreal_app_path, unreal_project_path, import_script_path, batch_index, num_batches):
    ...
    print("Starting worker with args:", subprocess_args)
    # & "C:\Program Files\Epic Games\UE_5.0\Engine\Binaries\Win64\UnrealEditor-Cmd.exe" -- "C:\Users\Ana\Documents\Unreal Projects\Bedlam\Bedlam.uproject" -ExecutePythonScript="C:/bedlam_render/unreal/import/import_abc_smplx.py 0 10"
